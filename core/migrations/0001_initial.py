# Generated by Django 2.2.4 on 2019-08-31 16:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'ObraSocials',
            },
        ),
        migrations.CreateModel(
            name='Paciente',
            fields=[
                ...
                ('tipo_documento', models.CharField(choices=[('DNI', 'DNI'), ('LC', 'LC'), ('LE', 'LE'), ('PASAPORTE', 'PASAPORTE'), ('OTRO', 'OTRO')], max_length=20)),
                ('numero_documento', models.CharField(blank=True, help_text='Deje en blanco si está indocumentado', max_length=30, null=True)),
                ('nacionalidad', models.CharField(choices=[('argentina', 'argentina'), ('boliviana', 'boliviana'), ('brasilera', 'brasilera'), ('chilena', 'chilena'), ('colombiana', 'colombiana'), ('ecuatoriana', 'ecuatoriana'), ('paraguaya', 'paraguaya'), ('peruana', 'peruana'), ('uruguaya', 'uruguaya'), ('venezolana', 'venezolana'), ('otra', 'otra')], max_length=50)),
                ...
                ('carpeta_familiar', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='miembros', to='core.CarpetaFamiliar')),
