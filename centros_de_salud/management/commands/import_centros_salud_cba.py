            ...
            for folder in folders:
                ...
                for place in places:
                    ...
                    <name>CS N° 1 - General Mosconi</name>
                        <description><![CDATA[Calle Pedro Naon 1330<br>Atención 7 - 21 hs<br>TE: 4335102 / 5428]]></description>
                    ...
                    self.stdout.write(" -- - Descr: {}".format(place.description))
                    ...
                    cs, created = CentroDeSalud.objects.get_or_create(nombre=place.name)
                    cs.descripcion = place.description
                    # esto tampoco funca
                    # ubicacion = GEOSGeometry(pt.wkt)
                    ubicacion = GEOSGeometry(f'POINT({pt.x} {pt.y})', srid=4326)
